...
struct Module {
    char*        mod_name;    // the name of the module. "net/http" and "test/http" are two different modules
    char*        mod_path;    // the path of the module.
    int          path_len;
    bool         depd_parsed; // whether the dependences of the module have been parsed.
    bool         is_main;     // whether the module is generated by .cplus file or .prog directory.
    SourceFiles* srcfiles;    // cplus source files in the module directory.
    SourceFiles* fiterate;    // used to travel the source file list
};
