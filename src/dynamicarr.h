...
extern error dynamicarr_char_init   (dynamicarr_char* darr, int64 capacity);
extern void  dynamicarr_char_append (dynamicarr_char* darr, char* str, int64 len);
extern void  dynamicarr_char_appendc(dynamicarr_char* darr, char  ch);
extern bool  dynamicarr_char_equal  (dynamicarr_char* darr, char* str, int64 len);
